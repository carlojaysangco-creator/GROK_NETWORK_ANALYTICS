"""Admin page – local CSV paste publish into GenerationStore."""
...
def admin_layout(_config: ApplicationConfig) -> html.Div:
    return html.Div(
        [
            html.H2("Admin"),
            html.P(
                "Publish local CSV text into GenerationStore. "
                "Collection and live topology remain disabled. No remote writes.",
                className="muted",
            ),
            html.Div(
                [
            ...
            html.Button("Publish & promote", id="admin-publish", n_clicks=0, className="primary-btn", style={"marginTop": "0.75rem"}),
